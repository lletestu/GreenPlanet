 ...
 * @author smjf
 */
public class CombinationForGoodPolluter {
     ...
     */
    public CombinationForGoodPolluter(ArrayOfSolution p,float cashCondition,float prorataCondition,float bonusEcoCondition,Player myPlayer,Game g)
    {
        tool = p ;
            ...
            for (int i = 0 ; i < ArrayOfSolution.nbMaxSolarPlant +1 ; i++)
            {
                for( int j=0 ; j < ArrayOfSolution.nbMaxWaterTurbine+1; j++)
                {
                    for(int k=0 ; k < ArrayOfSolution.nbMaxWindTurbine+1; k++)
                    {
                        ...
                        {
                            for( int m = 0 ; m < ArrayOfSolution.nbMaxCoalPlant+1; m++)
                            {
