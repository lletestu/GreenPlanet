...
/**
 * Derived class to NumberBuilding allowing to compute the current building of the player
 */
public class NumberBuildingActual extends NumberBuilding {
     ...
     */
    public NumberBuildingActual(ArrayList<Building> b, int turn) {
        super(b, turn);
    }

    /**
     * This method allows to return an array list of the name of building
    ...
    private ArrayList<String> availableBuildingNextTurn(ArrayList<Building> buildingPlayer, int turn){
        ...
        if(buildingPlayer!=null){
            for(Building b:buildingPlayer){
                availableBuilding.add(b.getType());
            }
        }
