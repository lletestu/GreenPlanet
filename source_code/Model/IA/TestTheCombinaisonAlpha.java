 ...
 */
public class TestTheCombinaisonAlpha {
    int choiceCase = -1;
    ...
    public TestTheCombinaisonAlpha(ArrayOfSolution p,float cashCondition,float prorataCondition,float bonusEcoCondition,Player myPlayer)
    {
        tool = p ;
